...
const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      <p>Retrieval-Augmented Generation, or RAG, is the architecture that makes Rekall-IQ possible. It combines two powerful capabilities: retrieving the right information from your documents and generating a natural-language answer from that information.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Rekall-IQ takes this further by combining semantic search with strict workspace isolation. Every search is filtered to your organisation\u2019s approved documents only.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Rekall-IQ addresses these questions with workspace isolation. Each organisation operates inside its own private boundary within the platform.</p>
      <h2>What Workspace Isolation Means</h2>
      <p>Every piece of data in Rekall-IQ is tagged with a workspace ID. This includes uploaded documents, text chunks, vector embeddings, chat messages, and user profiles. Every database query, vector search, and API call enforces this boundary at the application level.</p>
      ...
      <p>Rekall-IQ operators with the platform admin role can manage workspaces, view metadata, and monitor system health. By default, they do not read uploaded document text or browse private chat conversations. This boundary is by design, not by convention.</p>
      <h2>Why This Matters</h2>
      <p>Workspace isolation means compliance teams can approve Rekall-IQ for internal use without worrying about cross-tenant data leakage. It also means IT leaders can roll out AI-powered knowledge search with confidence.</p>
    `,
    author: 'Rekall-IQ Team',
    authorRole: 'Security',
    date: '1 May 2026',
  ...
  },
  {
    ...
    content: `
      ...
      <p>Rekall-IQ helps by making those answers instantly available through a simple AI chat interface.</p>
      ...
      <p>Upload your onboarding handbook, IT setup guides, HR policies, and training materials into a Rekall-IQ workspace. When new hires ask questions, they get immediate answers drawn from those approved documents, with source citations they can verify.</p>
      ...
      <p>Teams using Rekall-IQ for onboarding report fewer interruption-based questions, faster time-to-answer for new hires, and better documentation coverage as admins see which questions their documents fail to answer.</p>
    `,
    author: 'Rekall-IQ Team',
    authorRole: 'Product',
    date: '24 Apr 2026',
  ...
  },
  {
    ...
    content: `
      ...
      <p>Rekall-IQ uses Voyage AI as the default embedding provider for document and query embeddings. Here is why.</p>
      ...
      <p>When a workspace admin uploads documents, Rekall-IQ processes them through a batched embedding pipeline. Text chunks are sent to Voyage in batches of 20, with a maximum of 2 concurrent requests and a 500ms delay between batches. This keeps ingestion stable even for large document sets and avoids rate-limit errors.</p>
      <h2>Provider Flexibility</h2>
      <p>Rekall-IQ is built with a provider abstraction layer. While Voyage is the default, organisations can switch to Gemini embeddings by changing environment variables. The system adapts its vector dimensions and model selection automatically.</p>
      <p>This flexibility means Rekall-IQ can evolve as embedding technology improves, without requiring a platform rebuild.</p>
    `,
    author: 'Rekall-IQ Team',
    authorRole: 'Engineering',
    date: '18 Apr 2026',
