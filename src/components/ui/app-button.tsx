...
const toneClasses: Record<AppButtonTone, string> = {
  primary:
    "border-transparent bg-[#0d1f35] text-white shadow-[0_12px_28px_rgba(15,23,42,0.12)] hover:bg-[#132744] disabled:border-slate-200 disabled:bg-slate-200 disabled:text-slate-500",
  secondary:
