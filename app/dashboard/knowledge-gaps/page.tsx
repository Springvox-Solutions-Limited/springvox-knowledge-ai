    ...
    <div className="admin-page">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="space-y-1">
          <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-cyan-700">Knowledge Coverage</p>
      ...
      <div className="admin-shell-card">
        {loading ? (
          ...
          <div className="px-6 py-16 text-center">
            ...
            <p className="mt-4 text-sm font-semibold text-slate-950">No knowledge gaps found</p>
            <p className="mt-2 text-xs text-slate-500">Fallback questions will appear here.</p>
          </div>
        ) : (
          <div className="space-y-4 p-4 md:p-6">
            {filteredKnowledgeGaps.map((gap) => (
              <div key={gap.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-base font-semibold leading-7 text-slate-950">{gap.question}</p>
                    ...
                    {gap.sample_answer && (
                      <p className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-xs leading-6 text-slate-500">
